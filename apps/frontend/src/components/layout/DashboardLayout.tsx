  ...
  return (
    <div className="h-screen flex overflow-hidden bg-background">
      ...
      <div
        ...
        } fixed inset-y-0 left-0 z-50 w-64 bg-card shadow-lg transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-0`}
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-border">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h1 className="text-lg font-semibold text-foreground">ArtPlim ERP</h1>
            </div>
          </div>
          <button
            className="md:hidden"
        ...
        <div className="relative z-10 flex-shrink-0 flex h-16 bg-card shadow border-b border-border">
          ...
          <div className="flex-1 px-4 flex justify-between items-center">
            ...
            <div className="ml-4 flex items-center md:ml-6 space-x-3">
              {/* Theme Selector */}
              <div className="flex items-center gap-1 p-1 border border-border rounded-lg bg-card relative z-20">
                <button
                  onClick={() => setTheme('light')}
                  className={`p-2 rounded transition-colors cursor-pointer !min-h-[32px] !min-w-[32px] ${
                    theme === 'light' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-accent'
                  }`}
                  title="Claro"
                  type="button"
                >
                ...
                <button
                  ...
                  className={`p-2 rounded transition-colors cursor-pointer !min-h-[32px] !min-w-[32px] ${
                    theme === 'dark' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-accent'
                  }`}
                  title="Escuro"
                  type="button"
                >
                ...
                <button
                  ...
                  className={`p-2 rounded transition-colors cursor-pointer !min-h-[32px] !min-w-[32px] ${
                    theme === 'system' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-accent'
                  }`}
                  title="Sistema"
                  type="button"
                >
