...
export const createProductDto = z.object({
  ...
  wholesalePrice: z.coerce.number().min(0, 'Preço de atacado deve ser maior ou igual a zero').optional(),
...
export const productFiltersDto = z.object({
  ...
  showDeleted: z.coerce.boolean().optional(), // Adicionado para permitir a busca de produtos soft-deletados
});
